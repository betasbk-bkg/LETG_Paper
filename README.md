...
Submitted to *IEEE Transactions on Systems, Man, and Cybernetics: Systems* (2026), under double-blind review.

> **Author information has been removed for double-blind review.**
> Original repository identifiers, citation metadata, and contact information will be restored upon acceptance.
...
Author and citation information has been omitted for double-blind review. A machine-readable citation will be restored upon acceptance (see `CITATION.cff`).
